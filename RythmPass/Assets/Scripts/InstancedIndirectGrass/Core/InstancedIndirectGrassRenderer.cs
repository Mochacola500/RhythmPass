...
public class InstancedIndirectGrassRenderer : MonoBehaviour
{
    ...
    //=====================================================
    private ProfilingSampler _profilingSampler = new ProfilingSampler("Culling Compute");
    ...
    void LateUpdate()
    {
        ...
        cmd.SetComputeFloatParam(cullingComputeShader, "_MaxDrawDistance", drawDistance);
        ...
        using (new ProfilingScope(cmd, _profilingSampler))
        {
            for (int i = 0; i < visibleCellIDList.Count; i++)
            {
                ...
                cmd.SetComputeIntParam(cullingComputeShader, "_StartOffset", memoryOffset);
                ...
                cmd.DispatchCompute(cullingComputeShader, 0, Mathf.CeilToInt(jobLength / 64f), 1, 1);
